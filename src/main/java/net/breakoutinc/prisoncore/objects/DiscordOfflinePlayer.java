 ...
 */
public class DiscordOfflinePlayer implements Player {
    ...
    public DiscordOfflinePlayer(OfflinePlayer oPlayer,String discordid){
        op = oPlayer;
        u = BreakoutBot.getInstance().getJDA().getUserById(Long.parseLong(discordid));
        m = BreakoutBot.getInstance().guild.getMember(u);
    }
    ...
    public void sendRawMessage(String s) {
        ...
        u.openPrivateChannel().complete().sendMessage(s).complete();
    }
    ...
    public boolean performCommand(String s) {
        return PrisonCore.getInstance().getServer().dispatchCommand(this,s);
    }
    ...
    public boolean isBanned() {
        return PrisonCore.getInstance().getServer().getOfflinePlayer(this.getUniqueId()).isBanned();
    }
    ...
    public Location getLocation() {
        PrisonCore core = PrisonCore.getInstance();
        return core.getServer().getWorlds().get(0).getSpawnLocation();
    }
    ...
    public World getWorld() {
        PrisonCore core = PrisonCore.getInstance();
        return core.getServer().getWorlds().get(0);
    }
    ...
    public boolean hasPermission(String s) {
        return PrisonCore.getPerms().playerHas(null,op,s);
    }
